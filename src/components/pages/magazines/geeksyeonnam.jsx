      ...
      <div id="magazine notoSans" className="magazine">
        ...
        <div className="questAnswer">
          ...
          <div className="answer">
            ...
            <br />
            <span>
              또한, 매장에서는 원두 상태, 습도, 기기 등 최상의 맛을 낼 수 있도록
              매일 아침마다 세팅을 진행한 이후 손님을 받고 있습니다.
            </span>
          </div>
        </div>
        ...
        <div className="questAnswer">
          ...
          <div className="answer">
            ...
            <br />
            <span>
              현재 긱스에서도 술과 커피 모두 판매하고 있고 낮에는 밝은 조명을,
              저녁에는 어두은 조명을 통해 분위기를 다양하게 연출하고 있어요.
            </span>
          </div>
        </div>
        ...
        <div className="questAnswer">
          ...
          <div className="answer">
            ...
            <br />
            <span>
              커피의 취향을 찾을 수 있는 공간이 되기 위해 노력하는 긱스의 매력을
              알아봐주시는 거 같아서 너무 행복하고 앞으로도 초심을 잃지 않도록
              하겠습니다.
            </span>
          </div>
        </div>
        ...
        <Img1 img="./assets/magazinePages/geeksyeonnam/10.png" />
        <div className="questAnswer">
          <div className="question">
